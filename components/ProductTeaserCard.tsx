...
export const ProductTeaserCard = (props: ProductTeaserCardProps) => {
  const {
    dailyVolume = "Your Partner",
    dailyVolumeLabel = "FOR SMARTER BUSINESS",
    headline = "Your Partner for Smarter, Faster, More Profitable Business",
    subheadline = "DPK Consultants specializes in strengthening the core areas that determine business success. We work closely with founders and leadership teams to bring clarity, structure, and strategic direction.",
    description = "Operational clarity, Stronger financial decision-making, Scalable business development, Professional digital credibility.",
